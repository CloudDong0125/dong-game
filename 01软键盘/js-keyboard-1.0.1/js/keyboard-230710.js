const Keyboard = {
    ...
    initKeyboard() {
        ...
        var div = $('<div id="keyboard"></div>')
        var table = $('<table cellspacing="3" ></table>');

        var tr1 = $('<tr><td>!</td><td>@</td><td>#</td><td>$</td><td>%</td><td>^</td><td>&</td><td>*</td><td>(</td><td>)</td><td>_</td><td>+</td><td>|</td></tr>')
        var tr2 = $('<tr ><td >`</td><td class="num">1</td><td class="num">2</td><td class="num">3</td><td class="num">4</td> <td class="num">5</td><td class="num">6</td><td class="num">7</td><td class="num">8</td><td class="num">9</td><td class="num">0</td><td>-</td><td>=</td><td colSpan="2" width="" class="goback" id="goback" >←</td></tr>')
    ...
    clickKeyboard() {
        ...
        keyboard.addEventListener('click', function () {
            ...
            if (el.className == "toUptoLow") {
                ...
                // els.innerHTML.style.fontSize = '10px';
                // 遍历每一个字母
