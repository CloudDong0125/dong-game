var _keyboard = {
    ...
    show: function (el, call) {
        ...
        var innerBoxWidth = $(el)[0].clientWidth; //  获取宽度
        var innerBoxHeight = $(el)[0].clientHeight; // 获取高度
        ...
        var keyWidth=$('#_keyboard')[0].clientWidth
        var keyHeight=$('#_keyboard')[0].clientHeight


        console.log(innerBoxWidth,innerBoxHeight)
        console.log(innerBoxLeft,innerBoxTop)
        console.log(keyWidth,keyHeight)
        console.log(wrapperBoxWidth,wrapperBoxHeight)

        console.log("右侧溢出", (innerBoxLeft  + keyWidth) > wrapperBoxWidth)

        console.log(innerBoxHeight)
        console.log(innerBoxTop)
        console.log(wrapperBoxHeight)
        console.log("底部溢出", (innerBoxTop + innerBoxHeight+ keyHeight) > wrapperBoxHeight)
